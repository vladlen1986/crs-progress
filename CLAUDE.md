...
4. **Tiers:** 5 subscription tiers (module gating roadmap).
...
1. Check `design/design.md` for design questions
2. Check `data/CRS_Module_OptionSets.xlsx` for module data
3. Check `specs/CRS_Blueprint.html` for spec details
