# Checkbox element
> Source: https://manual.bubble.io/core-resources/bubble-elements/element-properties/web-element-properties/input-form-properties/checkbox-element · Captured: 2026-07-14 (verbatim from manual.bubble.io llms-full.txt)
...
**How do I read the checkbox value?**

Use `Checkbox's value`, which returns yes or no.

**Can I make it required?**

Yes. Use validation logic in workflows to prevent submission unless the checkbox is checked.
