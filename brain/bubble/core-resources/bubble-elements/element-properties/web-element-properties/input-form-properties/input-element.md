# Input element
> Source: https://manual.bubble.io/core-resources/bubble-elements/element-properties/web-element-properties/input-form-properties/input-element · Captured: 2026-07-14 (verbatim from manual.bubble.io llms-full.txt)
...
| Input format        | Description                                                                                                                                   | Sub-properties                                                                                                                                                                                                             |
| ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Text                | Accepts any text input without format restrictions.                                                                                           | Max number: the maximum length of the string.                                                                                                                                                                              |
| Email               | Accepts input formatted as an email address and enables email-specific validation.                                                            |                                                                                                                                                                                                                            |
| Password            | Masks the entered text with asterisks.                                                                                                        | Check the password while typing: if a password policy is defined in *Settings – General*, check this box to validate the input against that policy.                                                                        |
| Integer             | Accepts whole numbers only (no decimals).                                                                                                     | Show thousands separator: inserts the thousands separator (`,`) as the user types. Set a range: sets the minimum and/or maximum numerical value.                                                                           |
| Decimal             | Accepts numeric input including decimal values. Decimal inputs use a period (`.`) as the decimal separator -- commas (`,`) aren't recognized. | Decimal place: sets the number of digits to show after the decimal point. Show thousands separator: inserts the thousands separator (`,`) as the user types. Set a range: sets the minimum and/or maximum numerical value. |
| Address             | Accepts Google Maps-compatible addresses and automatically validates the address with Google Maps.                                            |                                                                                                                                                                                                                            |
| US phone            | Accepts phone numbers formatted for US standards and may apply formatting automatically.                                                      |                                                                                                                                                                                                                            |
| Percentage          | Accepts numeric input intended to represent percentages.                                                                                      | Decimal place: sets the number of digits to show after the decimal point. Set a range: sets the minimum and/or maximum numerical value.                                                                                    |
| Currency            | Accepts numeric input formatted as a currency value.                                                                                          | Decimal place: sets the number of digits to show after the decimal point. Set a range: sets the minimum and/or maximum numerical value.                                                                                    |
| Date                | Accepts dates in the US date format (mm.dd.yyyy).                                                                                             |                                                                                                                                                                                                                            |
| Euro date           | Accepts dates in the European date format (dd.mm.yyyy).                                                                                       |                                                                                                                                                                                                                            |
| Text (numbers only) | Accepts numeric characters only, but treats the value as text rather than a number.                                                           |                                                                                                                                                                                                                            |
