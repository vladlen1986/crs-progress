# Alert element
> Source: https://manual.bubble.io/core-resources/bubble-elements/element-properties/web-element-properties/visual-element-properties/alert-element · Captured: 2026-07-14 (verbatim from manual.bubble.io llms-full.txt)

Displays a contextual message to the user, typically for notifications or warnings.
...
The text to display in the alert. This text can also be set contextually in the [Show message in an alert box action](/core-resources/bubble-workflows/bubble-actions/element-actions#show-message-in-an-alert-box).
...
Positions the alert element at the top of the current page.
...
Since the alert element is displayed using the [Show message in an alert box action](/core-resources/bubble-workflows/bubble-actions/element-actions#show-message-in-an-alert-box), it doesn't have a visibility property.
