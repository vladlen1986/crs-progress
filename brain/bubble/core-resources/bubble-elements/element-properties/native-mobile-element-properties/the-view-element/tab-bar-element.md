# Tab bar element
> Source: https://manual.bubble.io/core-resources/bubble-elements/element-properties/native-mobile-element-properties/the-view-element/tab-bar-element · Captured: 2026-07-14 (verbatim from manual.bubble.io llms-full.txt)

The tab bar is a container that rests at the bottom of the screen and contains [tab items](/core-resources/bubble-elements/element-properties/native-mobile-element-properties/the-view-element/tab-bar-element/tab-item-element). It's not added from the element pallette, but instead appears when the current view has *Include as tab item* or *Show tab bar* enabled in the *Configure - Navigation* property.
