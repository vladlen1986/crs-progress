# Section list item element (mobile)
> Source: https://manual.bubble.io/core-resources/bubble-elements/element-properties/native-mobile-element-properties/the-view-element/section-list-element-mobile/section-list-item-element-mobile · Captured: 2026-07-14 (verbatim from manual.bubble.io llms-full.txt)

The section list item is a pseudo child element of the section [list element](/core-resources/bubble-elements/element-properties/native-mobile-element-properties/the-view-element/section-list-element-mobile). It's used to configure the look and behavior of each item in the current grouping. Each row returns the data source *Current item's \[data type].*
...
Sets the position of the element, relative to its parent element.
...
Swipe actions are added as a [*SwipeAction* element](/core-resources/bubble-elements/element-properties/native-mobile-element-properties/the-view-element/section-list-element-mobile/section-list-item-element-mobile/swipe-action-section-list-element-mobile), visible in the element tree. They can only be added from the vertical list item, and do not exist in the element pallet. You will see the element in the editor on the left or right side of the vertical list item.
...
Allows the list item itself to be interactive and trigger workflows.
