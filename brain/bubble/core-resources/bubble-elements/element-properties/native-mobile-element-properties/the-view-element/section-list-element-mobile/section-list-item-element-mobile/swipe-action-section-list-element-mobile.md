...
> Source: https://manual.bubble.io/core-resources/bubble-elements/element-properties/native-mobile-element-properties/the-view-element/section-list-element-mobile/section-list-item-element-mobile/swipe-action-section-list-element-mobile · Captured: 2026-07-14 (verbatim from manual.bubble.io llms-full.txt)
...
It's visible in the element tree, but cannot be added from the element palette. Instead, you add it in the properties of the [list item](/core-resources/bubble-elements/element-properties/native-mobile-element-properties/the-view-element/section-list-element-mobile/section-list-item-element-mobile).

The element gradually appears when the user swipes left or right on a [list item](/core-resources/bubble-elements/element-properties/native-mobile-element-properties/the-view-element/section-list-element-mobile/section-list-item-element-mobile). You can connect a workflow to the swipe action element just like other elements.
