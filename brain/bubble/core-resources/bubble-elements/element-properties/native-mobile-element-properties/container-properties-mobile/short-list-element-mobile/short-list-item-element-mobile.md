# Short list item element (mobile)
> Source: https://manual.bubble.io/core-resources/bubble-elements/element-properties/native-mobile-element-properties/container-properties-mobile/short-list-element-mobile/short-list-item-element-mobile · Captured: 2026-07-14 (verbatim from manual.bubble.io llms-full.txt)

The short list item is an automatically generated child element of the short list element. It controls the properties of each item in the short list. The properties you apply to this element is automatically applied to all items in the short list.
...
Makes the short list item pressable, allowing you to attach events and trigger workflows.
