...
> Source: https://manual.bubble.io/core-resources/bubble-elements/element-properties/native-mobile-element-properties/container-properties-mobile/group-element-mobile · Captured: 2026-07-14 (verbatim from manual.bubble.io llms-full.txt)

A Group is a general-purpose container that holds other elements. It serves both a visual and a data role in your app. Visually, a Group organizes elements into a single unit within the layout. Elements inside a Group move and resize together according to the Group’s layout settings.
...
Use Groups when you want a section of the view to display content relative to a specific dynamic entry, while keeping the layout and data context clearly scoped.
...
Allows the group itself to be interactive and trigger workflows. When enabled, you can attach tap/press events directly to the group.
...
<summary>Group (mobile) element: <strong>FAQ</strong></summary>
