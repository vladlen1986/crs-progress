# Horizontal List Item element (mobile)
> Source: https://manual.bubble.io/core-resources/bubble-elements/element-properties/native-mobile-element-properties/container-properties-mobile/horizontal-list-element-mobile/horizontal-list-item-element-mobile · Captured: 2026-07-14 (verbatim from manual.bubble.io llms-full.txt)

The horizontal list item element is a child element of the horizontal list element. It's automatically added in the element tree when a horizontal list element is created, and cannot be created as an individual element.

The horizontal list item element controls the properties of each item in the list. The properties you set are automatically applied to all items.
...
Allows the list item to be interactive and trigger workflows. When enabled, you can attach tap/press events directly to the container.
