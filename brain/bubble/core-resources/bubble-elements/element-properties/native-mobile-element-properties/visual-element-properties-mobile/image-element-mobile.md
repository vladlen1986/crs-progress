# Image element (mobile)
> Source: https://manual.bubble.io/core-resources/bubble-elements/element-properties/native-mobile-element-properties/visual-element-properties-mobile/image-element-mobile · Captured: 2026-07-14 (verbatim from manual.bubble.io llms-full.txt)

## Image

Displays a static or dynamic image file.
...
Upload a file through the property editor to display a static image.

#### URL

Click the plus icon to provide a direct image URL or generate one using a dynamic expression.
...
Makes the image clickable, allowing you to attach click events and trigger workflows.
