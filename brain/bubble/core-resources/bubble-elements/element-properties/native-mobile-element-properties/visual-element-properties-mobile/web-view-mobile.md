# Web view (mobile)
> Source: https://manual.bubble.io/core-resources/bubble-elements/element-properties/native-mobile-element-properties/visual-element-properties-mobile/web-view-mobile · Captured: 2026-07-14 (verbatim from manual.bubble.io llms-full.txt)

Web view displays an inline rendering of a web page in your app.

## Visual

### Content <a href="#content-11" id="content-11"></a>

#### Destination

Specifies which page from your app is loaded inside the web view element. The web view element can only display internal pages from the same Bubble app. External URLs or third-party websites are not supported

#### Data to send

Specifies the thing passed to the page defined in *Destination*.

The value must match the destination page’s *Type of content*. This sends the page thing, allowing the destination page to access and display the correct data.
...
### Options <a href="#options-9" id="options-9"></a>

#### Enable zooming

Allows users to pinch zoom in and out within the web view content.
