# Map element (mobile)
> Source: https://manual.bubble.io/core-resources/bubble-elements/element-properties/native-mobile-element-properties/visual-element-properties-mobile/map-element-mobile · Captured: 2026-07-14 (verbatim from manual.bubble.io llms-full.txt)
...
When enabled, the map service will be Apple Maps (instead of the default Google Maps) when the user is on an iOS device.
...
When enabled, the map displays the user's current location.
