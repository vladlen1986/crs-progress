# Running tests
> Source: https://docs.buildprint.ai/running-tests-lh4vs · Captured: 2026-07-14
...
Public REST routes for starting and reading runs:
...
The hosted MCP server exposes tools for test execution:
